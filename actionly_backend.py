# STAYFINDR BACKEND v12.8 - Final Link Fix
# FINAL FIX: Corrected the URL generation for BOTH Booking.com and TripAdvisor.
# The code now uses the direct, full URL provided by each API, which is the most reliable method
# and fixes all DNS_PROBE_FINISHED_NXDOMAIN errors.
...
# --- Flask Routes ---
@app.route('/')
def home(): return render_template_string('<h1>STAYFINDR Backend v12.8</h1><p>Final link fix version.</p>')
...
@app.route('/test')
def test_endpoint_route(): return jsonify({'status': 'STAYFINDR Backend v12.8 Active'})

# --- Application Startup ---
if __name__ == '__main__':
    logging.info("🚀 Starting STAYFINDR Backend v12.8...")

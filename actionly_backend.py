# STAYFINDR BACKEND v5.6 - Final Polished Production Version
# Incorporates user's updated search query for London.
...
CITIES = {
    ...
    'london': {'name': 'London, UK', 'coordinates': [51.5074, -0.1278], 'search_query': 'London UK', 'country': 'gb', 'tripadvisor_id': '186338'},
...
@app.route('/')
def home():
    return render_template_string('<h1>STAYFINDR Backend v5.6</h1><p>Production-ready. All systems operational.</p>')
...
def test_endpoint_route():
    return jsonify({'status': 'STAYFINDR Backend v5.6 Active', 'caching': 'enabled', 'logging': 'enabled'})

# --- Application Startup ---

if __name__ == '__main__':
    logging.info("🚀 Starting STAYFINDR Backend v5.6...")

...
@app.route('/')
def home():
    return render_template_string('<h1>STAYFINDR Backend v6.0</h1><p>City data is now loaded from cities.csv</p>')
...
def test_endpoint_route():
    return jsonify({'status': 'STAYFINDR Backend v6.0 Active', 'caching': 'enabled', 'logging': 'enabled', 'data_source': 'cities.csv'})

# --- Application Startup ---

if __name__ == '__main__':
    logging.info("🚀 Starting STAYFINDR Backend v6.0...")
